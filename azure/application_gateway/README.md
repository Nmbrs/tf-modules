...
| <a name="input_diagnostic_settings"></a> [diagnostic\_settings](#input\_diagnostic\_settings) | Diagnostic settings configuration for Application Gateway | <pre>object({<br/>    log_analytics_workspace = object({<br/>      name                = string<br/>      resource_group_name = string<br/>    })<br/><br/>    logs = object({<br/>      access_log_enabled      = bool<br/>      performance_log_enabled = bool<br/>      firewall_log_enabled    = bool<br/>    })<br/>    metrics_enabled = bool<br/>  })</pre> | n/a | yes |
