...
| <a name="output_service_plan_os_type"></a> [service\_plan\_os\_type](#output\_service\_plan\_os\_type) | The ID of the Azure Service Plan. |
| <a name="output_service_plan_sku_name"></a> [service\_plan\_sku\_name](#output\_service\_plan\_sku\_name) | The ID of the Azure Service Plan. |

## How to use it?

A number of code snippets demonstrating different use cases for the module have been included to help you understand how to use the module in Terraform.

## App Service Plan With One App

```hcl
module "app_service_plan" {
  source              = "./azure/app_service"
  service_plan_name   = "myserviceplan"
  resource_group_name = "rg-myapprg-dev"
  environment         = "dev"
  sku_name            = "P2v3"
  stack               = "dotnet"
  dotnet_version      = "v4.0"
  ...
  network_settings = {
    vnet_resource_group_name = "rg-myvnetrg-dev"
    vnet_name                = "vnet-myvenet-001-dev"
    subnet_name              = "snet-myappserviceplan-001"
  }
...
## App Service Plan With Multiple Apps
