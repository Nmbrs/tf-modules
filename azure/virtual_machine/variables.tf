...
variable "sku_name" {
  ...
  #   error_message = format("Invalid value '%s' for variable 'sku_name', valid options are 'Standard_D2s_v2', 'Standard_D4as_v5', 'Standard_D8as_v5','Standard_F4s_v2', 'Standard_F8s_v2', 'Standard_F16s_v2'.", var.sku_name)
  # }
}
