...
data "azurerm_private_dns_zone" "private_dns_zone" {
  name                = var.private_dns_zone_settings.use_custom_dns_zone ? var.private_dns_zone_settings.custom_name : lookup(local.private_dns_zones, var.resource_settings.types[0], null)
